# GEO Tracking — Visibilité MSD Media dans les IA

Tester manuellement chaque mois dans ChatGPT, Perplexity, Claude et Gemini (mode sans mémorisation / nouvelle conversation).
Noter ✅ si MSD Media est cité, ❌ sinon, 🔸 si cité indirectement (ex: dans une liste).
...
**OpenLens** — [tryopenlens.com](https://tryopenlens.com)
Audit gratuit de visibilité sur ChatGPT, Claude, Google AI, Perplexity, DeepSeek.

---

## Historique des changements GEO appliqués
